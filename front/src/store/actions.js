...
export const SET_CATEGORY_BY_LESSONID = 'actions/SET_CATEGORY_BY_LESSONID';
...
export const DELETE_ASK_LESSON = 'actions/DELETE_ASK_LESSON';
export const UPDATE_ASKLESSON_IN_BDD = 'actions/UPDATE_ASKLESSON_IN_BDD';
